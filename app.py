...
if selected=='HOME':
        ...
        if csubmit_button and cflag==0:
            import pickle
            with open(r"E:\Capstone5\Copper-Industry\cmodel.pkl", 'rb') as file:
                cloaded_model = pickle.load(file)

            with open(r'E:\Capstone5\Copper-Industry\cscaler.pkl', 'rb') as f:
                cscaler_loaded = pickle.load(f)

            with open(r"E:\Capstone5\Copper-Industry\ct.pkl", 'rb') as f:
...
st.write( f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by Neelakandan</h6>', unsafe_allow_html=True )  
